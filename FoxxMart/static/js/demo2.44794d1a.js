...
},{"gsap":"TpQl","./utils":"MgTz"}],"Ap5D":[function(require,module,exports) {
"use strict";
...
var GalleryItem = /*#__PURE__*/function () {
  function GalleryItem(el) {
    ...
    this.captionRect = this.DOM.caption.title.getBoundingClientRect(); // part of the stack
  ...
  _createClass(GalleryItem, [{
    ...
    value: function initEvents() {
      ...
      this.onMouseEnterFn = function () {
        _gsap.gsap.killTweensOf(_this.DOM.captionChars);
        ...
        _gsap.gsap.timeline({
          ...
          x: function x(pos) {
            return _this.imgRect.width - _this.captionRect.width * 1.1;
          },
          stagger: -0.02
        }, 0);
      };
...
},{"gsap":"TpQl"}],"ez7q":[function(require,module,exports) {
var global = arguments[3];
"use strict";
...
},{}],"usoU":[function(require,module,exports) {
"use strict";
    ...
    value: function intro() {
      ...
      try {
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          ...
          _gsap.gsap.set(item.DOM.el, {
            zIndex: this.itemsTotal - 1 - pos
          });
        }
      } catch (err) {
        _iterator.e(err);
      ...
      _gsap.gsap.to(this.DOM.galleryEl, {
        duration: 1.2,
        ease: 'expo',
        startAt: {
          y: '4%'
      ...
      var _this$galleryItems$ma = this.galleryItems.map(function (el) {
        return el.DOM.img;
          ...
          secondImage = _this$galleryItems$ma2[1],
          thirdImage = _this$galleryItems$ma2[2],
          otherImages = _this$galleryItems$ma2.slice(3);

      this.galleryItems.reverse();

      var timeline = _gsap.gsap.timeline(); // first let's center the images
      ...
      try {
        for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
          ...
          timeline.set(_item.DOM.img, {
            x: winsize.width / 2 - _item.imgRect.left - _item.imgRect.width / 2,
            y: winsize.height / 2 - _item.imgRect.top - _item.imgRect.height / 2,
            scale: 0.6,
          ...
          if (_pos >= this.itemsTotal - 3) {
            timeline.set(_item.DOM.imgInner, {
              scale: 1.8
            }, 0);
          } else {
            timeline.set(_item.DOM.img, {
      ...
      timeline.addLabel('startAnimation', '+=0.1').add(function () {
        document.body.classList.remove('noscroll');
        scroll.update();
      }, 'startAnimation').to([firstImage, secondImage, thirdImage], {
        duration: 1.2,
        ease: 'expo',
        x: 0,
        y: 0,
        ...
        rotation: 0,
        opacity: 1
      }, 'startAnimation').to(this.galleryItems.filter(function (_, pos) {
        return pos >= _this2.itemsTotal - 3;
      }).map(function (item) {
        return item.DOM.imgInner;
      }), {
        duration: 1.2,
        ease: 'expo',
        scale: 1
      }, 'startAnimation').to(otherImages, {
        duration: 1.2,
        ease: 'expo',
        startAt: {
          x: 0,
      ...
      var _iterator3 = _createForOfIteratorHelper(this.galleryItems),
          _step3;
      ...
      try {
        var _loop = function _loop() {
          ...
          }, 'startAnimation+=1.2').to(item.DOM.captionChars, {
            duration: 1,
            ease: 'expo',
            startAt: {
              opacity: 0,
...
},{"gsap":"TpQl","../utils":"MgTz","./galleryItem":"Ap5D","locomotive-scroll":"ez7q","splitting":"Qdhu"}],"ZSzT":[function(require,module,exports) {
"use strict";
...
},{"../utils":"MgTz","../cursor":"LMRJ","./galleryController":"usoU"}]},{},["ZSzT"], null)
