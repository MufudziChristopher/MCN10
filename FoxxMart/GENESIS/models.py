...
class GENESISCustomer(models.Model):
    User            = settings.AUTH_USER_MODEL
    user            = models.OneToOneField(User, on_delete=models.CASCADE, null=True, blank=True)
    date_created    = models.DateTimeField(auto_now_add=True, null=True, blank=True)
    shippingAddress = models.ForeignKey('GENESISShippingAddress', on_delete=models.SET_NULL, blank=True, null=True)
...
class GENESISOrder(models.Model):
    STATUS = (
        ('Pending', 'Pending'),
    ...
    customer = models.ForeignKey(GENESISCustomer, on_delete=models.SET_NULL, blank=True, null=True)
...
class GENESISOrderItem(models.Model):
    product = models.ForeignKey(GENESISProduct, on_delete=models.SET_NULL, blank=True, null=True)
    order = models.ForeignKey(GENESISOrder, on_delete=models.SET_NULL, blank=True, null=True)
...
class GENESISShippingAddress(models.Model):
